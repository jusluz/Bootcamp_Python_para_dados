...
Nesta segunda aula, foram apresentados alguns conceitos fundamentais básicos, além de explorar algumas práticas de tratamento e contorno de 
alguns erros usando TypeError, Type Check, Type Conversion, try-except e if.
